...
function showArrows(index, arrows) {
  ...
  if(
    ...
    if(!arrows[index].isRemoved){
      arroes[index].remove(index,arrows);
    }else{
...
reduceLife()
  if(
    baseCollision.isCollided ||
    archerCollision.isCollided ||
    playerCollision.isCollided 
    &&
...

{
  ...
  if(computerArcherLife<=0){
    ...
    Matter.Body.setStatic(computerArrows.body,true)
  ...
  if(playerArcherLife<=0){
    ...
    Matter.Body.setStatic(playerArrows.body,true)
